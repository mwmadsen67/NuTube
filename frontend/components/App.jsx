...
import { faVideo, faBars, faSpinner, faSearch, faThumbsUp, faThumbsDown, faArrowAltCircleUp as fasArrowAltCircleUp, faAddressCard, faUsers, faSignOutAlt} from '@fortawesome/free-solid-svg-icons';
import { faArrowAltCircleUp as farArrowAltCircleUp} from '@fortawesome/free-regular-svg-icons';

library.add(faVideo, faBars, faSpinner, faSearch, faThumbsUp, faThumbsDown, fasArrowAltCircleUp, farArrowAltCircleUp, faAddressCard, faUsers, faSignOutAlt);
